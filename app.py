...
with tab1:
    ...
    if filtered_df.empty:
        ...
        st.markdown("""
        <span style='color: #F39C12;'>⚠️ Caution:</span> _Trends may be influenced by outlier dates (Jun 5 & Aug 15, 2017). These can also be excluded using the **date range** filter._
